# nomad-workflow-parser

Workflow partser for amstools
...
```
pip install dist/nomad-workflow-parser-0.1.0
```
...
### License
Distributed under the terms of the `MIT`_ license, "nomad-workflow-parser" is free and open source software
